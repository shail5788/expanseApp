...
export const ROUTES: RouteInfo[] = [
    ...
    } ,
    {
        ...
        submenu: [
            { path: '/user-management/add-user', title: 'Add User', icon: '', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
            { path: '/user-management/user-list', title: 'User List', icon: '', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
        ]
    } ,
    {
        path: '', title: 'Expanse Mgt', icon: 'mdi mdi-bullseye', class: 'has-arrow', label: '', labelClass: '', extralink: false,
        submenu: [
            { path: '/component/accordion', title: 'Expanse Managenent', icon: '', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
            { path: '/component/alert', title: 'Alert', icon: '', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
